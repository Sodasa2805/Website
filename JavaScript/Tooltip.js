function tooltip() {
	const tooltips = Array.from(document.querySelectorAll('[tooltip-container]'));
	...
	const handleMouseMove = {
		handleEvent(e) {
			this.tooltipbox.style.top = e.clientY + 15 + 'px';
			this.tooltipbox.style.left = e.clientX + 5 +'px';
		}
	}
